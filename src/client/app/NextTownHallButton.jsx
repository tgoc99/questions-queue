  ...
  render() {
    ...
    return this.state.showButton ? (
      <div className>
        ...
        >
          {`Are you sure you want to move to the Next Town Hall?
            All questions without the "KEEP" flag enabled will be still be accessable,
            but will not show up by default.
            Please "BOOKMARK" any questions you want to roll over to the next Town Hall`}
        </Dialog>
      </div>
    ) : null;
  }
